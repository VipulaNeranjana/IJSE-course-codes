...
//        stage.setHeight(400);
        ...
        btnDialogs.setOnAction(event -> showFxDialogStage());
    }
...
//            Image image = new Image("/img/background-image.png"); // Java FX Only
            ...
            Image image = new Image(this.getClass().getResource("/img/jj.png").toString());
            img1.setImage(image);
...
//            Image image = new Image(new File("data/img/background-image.jpg").toURI().toString());
            Image image = new Image(Path.of("data/img/mm.jpg").toUri().toString());
...
//                new SimpleIntegerProperty()
        ...
        lblStop.setOnMouseClicked(mouseEvent -> {
        ...
        lblPlay.setOnMouseClicked(mouseEvent -> {
            MediaPlayer videoPlayer = mediaView.getMediaPlayer();
        ...
        lblSpeaker.setOnMouseClicked(mouseEvent -> {
        ...
        stgVideoPlayer.setOnCloseRequest(windowEvent -> {
            MediaPlayer videoPlayer = mediaView.getMediaPlayer();
    ...
    private  void showFxDialogStage(){
        if (stgDialogs != null) return;

        stgDialogs = new Stage();
        stgDialogs.setTitle("Video Player Demo");
        dialogScene();
        stgDialogs.show();
    ...
    private void dialogScene(){
        Button btnErrorMsg = new Button("Error msg");
        Button btnWrnMsg = new Button("Wrn msg");
        Button btnInfMsg = new Button("Inf msg");
        Button btnCustomMsg = new Button("Custom msg");
        Button btnConformationMsg = new Button("Conformation msg");

        VBox root = new VBox(btnInfMsg, btnErrorMsg, btnWrnMsg, btnCustomMsg,btnConformationMsg);
        root.setSpacing(10);
        root.setPadding(new Insets(10));
        ...
        btnErrorMsg.setOnMouseClicked(mouseEvent -> {
            Alert errAlert =new Alert(Alert.AlertType.ERROR,"something went wrong");
            errAlert.show();
        });
        btnWrnMsg.setOnMouseClicked(mouseEvent -> {
            Alert worAlert = new Alert(Alert.AlertType.WARNING,"Warning ,Dont do it");
            worAlert.show();
        });
        btnInfMsg.setOnMouseClicked(mouseEvent -> {
            Alert infAlert = new Alert(Alert.AlertType.INFORMATION,"inf, do it this way");
            infAlert.show();
        });
        btnCustomMsg.setOnMouseClicked(mouseEvent -> {
            Alert customAlert = new Alert(Alert.AlertType.NONE,"this is custom alert",
                    ButtonType.YES,ButtonType.NO,ButtonType.CANCEL);
            customAlert.setTitle("custom alert");
            customAlert.setHeaderText("this is header text");

            Image image = new Image(getClass().getResource("/icon/play.png").toString(), 32, 32, true, true);
            ImageView imgView = new ImageView(image);
            customAlert.setGraphic(imgView);
            customAlert.show();
        });
        btnConformationMsg.setOnMouseClicked(mouseEvent -> {
            Alert conformationAlert = new Alert(Alert.AlertType.CONFIRMATION,"Are you Sure?",
                    ButtonType.YES,ButtonType.NO);
            Optional<ButtonType> button = conformationAlert.showAndWait();
